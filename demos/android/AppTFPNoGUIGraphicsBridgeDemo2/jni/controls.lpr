...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo2'
       +'/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls'
    +'_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls'
    +'_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo2_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o2_Controls_pAppOnClickOptionMenuItem',
  ...
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo2_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo2_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnLongClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo2_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnLayouting';
...
begin
  ...
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo2';{AndroidWidget.pas}
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo2/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 1:50:31*)
