...
library controls;  //by Lamw: Lazarus Android Module Wizard: 9/8/2015 22:42:12]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo1'
       +'/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls'
    +'_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls'
    +'_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o1_Controls_pAppOnClickOptionMenuItem',
  ...
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnLongClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_apptfpnoguigraphicsbridgedemo1_Controls_'
    +'pOnLayouting';
...
begin
  ...
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 1:46:30*)
